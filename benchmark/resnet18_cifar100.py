...
def main():
    # Training settings
    parser = argparse.ArgumentParser(description='PyTorX ResNet18 CIFAR-100 Example')
    ...
    if not args.test:
        for epoch in range(args.epochs):
            ...
            filename = 'checkpoint_resnet18_cifar100_' + str(args.crxb_size) + '.pth.tar'
        ...
        modelfile = 'checkpoint_resnet18_cifar100_' + str(args.crxb_size) + '.pth.tar'
