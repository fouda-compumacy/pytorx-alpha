...
class VGG9(nn.Module):
    """VGG9 network for CIFAR-10 mapped onto ReRAM crossbar arrays.
...
def main():
    # Training settings
    parser = argparse.ArgumentParser(description='PyTorX VGG9 CIFAR-10 Example')
    ...
    if not args.test:
        for epoch in range(args.epochs):
            ...
            filename = 'checkpoint_cifar10_' + str(args.crxb_size) + '.pth.tar'
        ...
        modelfile = 'checkpoint_cifar10_' + str(args.crxb_size) + '.pth.tar'
